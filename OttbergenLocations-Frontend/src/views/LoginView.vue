    ...
    <div class="max-w-md w-full space-y-8">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-booking-gray-brown">
          Oder
          <router-link to="/register" class="font-medium text-booking-medium-brown hover:text-booking-dark-brown">
...
const handleLogin = () => {
  ...
  if (login(email.value, password.value)) {
    // Weiterleitung zur ursprünglich angeforderten Seite oder Home
