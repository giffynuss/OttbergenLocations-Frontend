  ...
  <nav class="fixed top-0 left-0 right-0 z-50 bg-luxury-dark shadow-luxury-lg border-b-2 border-luxury-gold">
      ...
      <div class="flex justify-between items-center h-20">
        ...
        <div class="flex-shrink-0">
          <router-link to="/" class="flex items-center">
            <span
              class="text-2xl font-luxury font-bold text-luxury-ivory tracking-luxury-wide hover:text-luxury-gold transition-colors duration-300">
              BOOK A PLACE
            </span>
          </router-link>
        </div>
          ...
          <template v-else>
            <div class="flex items-center space-x-3 ml-4 pl-4 border-l-2 border-luxury-gold">
              ...
              <router-link to="/profile"
                class="w-10 h-10 bg-luxury-cream flex items-center justify-center hover:bg-luxury-gold transition-colors duration-300 cursor-pointer border border-luxury-gold">
        ...
        <div class="md:hidden">
          <button @click="mobileMenuOpen = !mobileMenuOpen"
            ...
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path v-if="!mobileMenuOpen" stroke-linecap="square" stroke-linejoin="miter" stroke-width="2"
    ...
    <div v-if="mobileMenuOpen" class="md:hidden bg-luxury-brown border-t-2 border-luxury-gold">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <router-link to="/manage-places" @click="mobileMenuOpen = false"
          class="block px-4 py-3 text-base font-medium text-luxury-ivory hover:bg-luxury-dark transition-colors duration-300 border-b border-luxury-medium">
          Orte einstellen
        </router-link>
